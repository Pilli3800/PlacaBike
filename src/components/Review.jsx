    ...
    return(
        <div data-aos="fade-down" className="review__container">
            <div className="profile">
                ...
                <img className="profile-bikewithoutwheels" src={bicicletasinruedas} alt="sda"></img>
                <div className="ruedas">
                    <img className="profile-wheel wheel1" src={rueda}></img>
                    <img className="profile-wheel wheel2" src={rueda}></img>
                </div>
